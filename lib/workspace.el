...
(defun init-pageflow-monorepo-multi-terms ()
  ...
  (ensure-multi-term "*pageflow package*" "$HOME/code/gh/pageflow/packages/pageflow" ?p)
  (ensure-multi-term "*pageflow-react package*" "$HOME/code/gh/pageflow/packages/pageflow-react" ?R)
  (ensure-multi-term "*pageflow-react Build*" "$HOME/code/gh/pageflow/packages/pageflow-react" ?2)
